...
<style>
  ...
  *{box-sizing:border-box}
  ...
  .photo{
    ...
    display:block;
    background:#fff;
    animation: sway 6s ease-in-out infinite; /* Menambahkan efek sway */
  }
  ...
  .a-text{ animation: fadeUp .6s ease both }
  .a-photo{ animation: zoomIn .6s ease .05s both }
  .a-caption{ animation: floatIn .5s ease .1s both }
...
<main class="app" aria-live="polite">
  ...
  <section class="slides" id="slides">
    ...
    <article class="slide active" data-has-audio="true">
      ...
      <img class="photo a-photo" src="3.jpg" alt="Foto berdua pembuka">
      <p class="text a-text">HAPPY ANNIVERSARY 💋</p>
    </article>

    <!-- SLIDE 1 -->
    <article class="slide">
      <h2 class="title a-text">foto pertama</h2>
      <img class="photo a-photo" src="6.jpg" alt="Foto pertama">
      <p class="text a-text">slid kedua ini aku mau ngingetin ...</p>
    </article>

    <!-- SLIDE 2 -->
    <article class="slide">
      <h2 class="title a-text">hal yang biki aku suka sama aku</h2>
      <img class="photo a-photo" src="1.jpg" alt="Momen lucu">
      <p class="text a-text">Ya seng marai aku tambah suka ...</p>
    </article>

    <!-- SLIDE 3 -->
    <article class="slide">
      <h2 class="title a-text">inner voice</h2>
      <img class="photo a-photo" src="5.jpg" alt="Couple standing on mountain">
      <p class="text a-text">Setiap perjalanan ...</p>
    </article>

    <!-- SLIDE 4 -->
    <article class="slide">
      <h2 class="title a-text">Sumala roared</h2>
      <img class="photo a-photo" src="7.jpg" alt="Close-up cuddling">
      <p class="text a-text">Nahh iki nak gek nesu ya 🤣🤣...</p>
    </article>

    <!-- SLIDE 5 -->
    <article class="slide">
      <h2 class="title a-text">foto favorit</h2>
      <img class="photo a-photo" src="4.jpg" alt="Couple sunset">
      <p class="text a-text">njay foto favorit ...</p>
    </article>
    ...
    <!-- SLIDE 7 SURAT -->
    <article class="slide">
      <h2 class="title a-text"></h2>
      <div class="envelope" id="envelope">
        <div class="flap"></div>
        <div class="letter">
          <p class="text a-text" style="animation: sideSway 6s ease-in-out infinite;">
            Makasih yaa udah hadir di kehidupanku…<br>
            YOU'RE STILL MY FAVORITE WOMAN MUAHH 💋
          </p><p>
    </article>
  </section>
